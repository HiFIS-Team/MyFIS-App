...
const List<RankBoard> kRankBoards = [
  ...
  RankBoard(label: '적립왕', unit: 'P', entries: [
    RankEntry(1, '정우성', 48200, change: 1),
    RankEntry(2, '김철수', 45100),
    RankEntry(3, '박지연', 41800, change: 3),
    RankEntry(4, '이영희', 39600, change: -1),
    RankEntry(5, '강민지', 36200, isNew: true),
    RankEntry(6, '최동욱', 33900, change: 2),
    RankEntry(7, '정수진', 31500, change: -2),
    RankEntry(8, '나', 29800, change: 4, isMe: true),
    RankEntry(9, '윤서연', 27300),
    RankEntry(10, '임재현', 24600, change: 1),
    RankEntry(11, '한지우', 22100, change: -3),
    RankEntry(12, '오세훈', 19800, change: 2),
    RankEntry(13, '장도연', 17400),
    RankEntry(14, '신유빈', 15200, change: -1),
    RankEntry(15, '배수지', 12900, isNew: true),
    RankEntry(16, '문상혁', 10500, change: 1),
    RankEntry(17, '권지용', 8300, change: -2),
    RankEntry(18, '한소희', 6100),
  ]),
];
