...
object MyFisColor {
    ...
    // `1.724` → `1.947:1` 로 **13% 세졌다.** 우리가 고른 값이 아니라 딸려 온 값이라
    // 예전 세기(`1.692:1`)로 되돌린다 — **의도한 값으로 돌리는 것**이지 선을 줄이는 게 아니다.
    val BorderSubtle = Color(0xFF383941)
