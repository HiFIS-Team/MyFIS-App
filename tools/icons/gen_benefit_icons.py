...
ICONS = {
    ...
    # 물 마시기 — 잔은 옅은 톤, 담긴 물만 진하게. 물 높이가 곧 "얼마나 마셨나"다
    "ic_benefit_water": (
        [("M6.9,3.4 H17.1 L15.9,20.6 A1.7,1.7 0 0,1 14.2,22.2"
          " H9.8 A1.7,1.7 0 0,1 8.1,20.6 Z", True),
         ("M7.32,10 H16.68 L15.9,20.6 A1.7,1.7 0 0,1 14.2,22.2"
          " H9.8 A1.7,1.7 0 0,1 8.1,20.6 Z", False)], None),
