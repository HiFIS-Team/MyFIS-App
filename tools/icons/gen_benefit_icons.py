...
ICONS = {
    ...
    # 인스타 — 업로드 쟁반은 어느 앱에나 있는 그림이었다. 사진틀로
    "ic_benefit_sns": (
        [(circ(12, 12, 4), True),
         (rrect(2.6, 2.6, 18.8, 18.8, 5.6) + " " + rrect(5.2, 5.2, 13.6, 13.6, 3.4)
          + " " + circ(16.8, 7.5, 1.3), False)], "evenodd"),

    # 퀴즈 — 한 톤이라 납작했다. 말풍선을 옅은 판으로 내리고 물음표만 진하게
    "ic_benefit_quiz": (
        [("M4.6,3.4 h14.8 a2.2,2.2 0 0,1 2.2,2.2 v9.6 a2.2,2.2 0 0,1 -2.2,2.2"
          " h-6.2 l-4.4,3.4 v-3.4 h-4.2 a2.2,2.2 0 0,1 -2.2,-2.2 v-9.6"
          " a2.2,2.2 0 0,1 2.2,-2.2 Z", True),
         ("M12.1,5.4 a3.7,3.7 0 0,0 -3.7,3.5 h2.4 a1.3,1.3 0 1,1 2.1,1.2 l-2.1,1.6 v1.9"
          " h2.4 v-1 l1.4,-1.1 a3.7,3.7 0 0,0 -2.5,-6.1 Z M10.8,14.6 h2.4 v2.2 h-2.4 Z",
          False)], None),
}
