...
enum BenefitKind {
    ...
    var lightColor: Color {
        switch self {
        case .attend: MyFisColor.lightAccentGold
        case .routine: MyFisColor.lightAccentLime
        case .cardio: MyFisColor.lightAccentBlue
        case .stretch: MyFisColor.lightAccentViolet
        case .water: MyFisColor.lightAccentCyan
        case .dice: MyFisColor.lightAccentOrange
        case .luck: MyFisColor.lightAccentTeal
        case .scratch: MyFisColor.lightAccentFuchsia
        case .quiz: MyFisColor.lightAccentIndigo
        case .touch: MyFisColor.lightAccentGreen
        case .sns: MyFisColor.lightAccentPink
        case .weight: MyFisColor.lightAccentCoral
        case .diet: MyFisColor.lightAccentGray
        }
    }
...
enum BenefitPlaceholder {
    ...
    static let actions: [BenefitAction] = [
        .init(id: 1, kind: .attend, icon: "ic_benefit_attend_color", title: "오늘 출석 도장 찍기",
              reward: "+50 P 받기", introIcon: "ic_benefit_attend"),
        .init(id: 2, kind: .routine, icon: "ic_benefit_routine_color", title: "오늘 루틴 끝내기",
              reward: "+80 P 받기", introIcon: "ic_benefit_routine"),
        .init(id: 3, kind: .cardio, icon: "ic_benefit_cardio_color", title: "유산소 10분 채우기",
              reward: "10분마다 +10 P", introIcon: "ic_benefit_cardio"),
        .init(id: 4, kind: .stretch, icon: "ic_benefit_stretch_color", title: "AI가 고른 3동작 따라 하기",
              reward: "+20 P 받기", introIcon: "ic_benefit_stretch"),
        .init(id: 5, kind: .water, icon: "ic_benefit_water_color", title: "제때 물 마시기",
              reward: "하루 2번 마시면 +50 P", introIcon: "ic_benefit_water"),
        // 랜딩에도 이 그림을 그대로 쓴다 — 주사위는 두 톤 벌이 아예 없다
        .init(id: 6, kind: .dice, icon: "ic_benefit_dice_color", title: "주사위 굴리기",
              reward: "나온 눈만큼 P 받기"),
        .init(id: 7, kind: .luck, icon: "ic_benefit_luck_color", title: "뽑기 돌리기",
              reward: "랜덤 P 받기", badge: "이벤트", introIcon: "ic_benefit_luck"),
        // 주사위 · 뽑기 바로 뒤에 둔다 — **운으로 받는 셋**이 한 덩어리로 읽힌다
        .init(id: 13, kind: .scratch, icon: "ic_benefit_scratch_color", title: "은박 카드 긁기",
              reward: "숨은 P 받기"),
        .init(id: 8, kind: .quiz, icon: "ic_benefit_quiz", title: "AI가 생각하는 퀴즈 풀기",
              reward: "+30 P 받기"),
        .init(id: 9, kind: .touch, icon: "ic_benefit_touch_color", title: "함께 마일리지 받기",
              reward: "+10 P 받기", badge: "신규", introIcon: "ic_benefit_touch"),
        .init(id: 10, kind: .sns, icon: "ic_benefit_sns", title: "인스타에 인증샷 올리기",
              reward: "+100 P 받기", badge: "인기"),
        .init(id: 11, kind: .weight, icon: "ic_benefit_scale_color", title: "오늘 체중 재기",
              reward: "+20 P 받기", introIcon: "ic_benefit_scale"),
        .init(id: 12, kind: .diet, icon: "ic_benefit_diet_color", title: "먹은 것 사진 찍기",
